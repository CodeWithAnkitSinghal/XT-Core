...
class ShoppingCartService{
    constructor(){
        this.bannerURL="http://localhost:5800/categories";
        this.carouselUrl ="http://localhost:5800/banners";
        this.categoryUrl ="http://localhost:5800/categories";
        this.productUrl ="http://localhost:5800/products";
    }
    async getBannerData(){
        try{
